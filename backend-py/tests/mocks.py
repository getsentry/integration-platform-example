...
ALERT_RULE_ACTION_SETTINGS = list(
    map(
...
MOCK_WEBHOOK = {
    ...
    "event_alert.triggered:with_alert_rule_action": MOCK_EVENT_ALERT_TRIGGERED_WEBHOOK_WITH_ALERT_RULE_ACTION,
    "metric_alert.resolved": MOCK_METRIC_ALERT_RESOLVED_WEBHOOK,
    "metric_alert.warning": MOCK_METRIC_ALERT_WARNING_WEBHOOK,
    "metric_alert.warning:with_alert_rule_action": MOCK_METRIC_ALERT_WARNING_WEBHOOK_WITH_ALERT_RULE_ACTION,
    "metric_alert.critical": MOCK_METRIC_ALERT_CRITICAL_WEBHOOK,
    "metric_alert.critical:with_alert_rule_action": MOCK_METRIC_ALERT_CRITICAL_WEBHOOK_WITH_ALERT_RULE_ACTION,
}

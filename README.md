...
> Note: If you are using an M1 Mac, you may encounter an [issue](https://github.com/getsentry/integration-platform-example/issues/48) building the backend-py container. Running `export DOCKER_DEFAULT_PLATFORM=linux/amd64` prior to building the images should solve the issue. [Learn More](https://stackoverflow.com/questions/62807717/how-can-i-solve-postgresql-scram-authentifcation-problem).
